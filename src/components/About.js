  ...
  return (
    <div className="about">
     ...
     user experiences. I'm dedicated to writing clean,
      ...
      <div className="left">
        <img src={coder} width={600} height={500} alt="coder" className="right" />
      </div>
      ...
      <img className="bounce" src={htmllogo} width={200} height={100} alt="html" />
    </i>
    <i className="icon" data-tooltip="CSS">
      <img className="bounce" src={cssIcon} width={160} height={107} alt="css" />
    </i>
    <i className="icon" data-tooltip="JAVASCRIPT">
      <img className="bounce" src={jsIcon}idth={250} height={126} alt="javascript" />
    </i>
    <i className="icon" data-tooltip="REACT">
      <img className="bounce" src={reactIcon} width={150} height={115} alt="react" />
    </i>
